...
ACTION_POLICY_HIDDEN_DIM = 64  # hidden layer size for the action policy neural network
...
### GOAL POLICY
GOAL_POLICY_HIDDEN_DIM = 20  # hidden layer size for the goal selection neural network
